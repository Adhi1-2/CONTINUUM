...
CONTINUUM is one library (`src/continuum`, 124 modules) plus a large test suite (155 test files, ~2,122 tests). All modules append to and replay one hash chained event log:
