...
pytest -q                        # ~2,421 coletados, ~2,320 passando, ~27 pulados em um ambiente mínimo (as contagens exatas variam)
...
O CONTINUUM é uma biblioteca (`src/continuum`, 124 módulos) mais uma suíte de testes grande (161 arquivos de teste, ~2,421 testes). Todos os módulos acrescentam e reproduzem um log de eventos encadeado:
