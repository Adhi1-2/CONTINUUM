...
pytest -q                        # ~2,313 coletados, ~2,253 passando, ~25 pulados em um ambiente mínimo (as contagens exatas variam)
...
O CONTINUUM é uma biblioteca (`src/continuum`, 124 módulos) mais uma suíte de testes grande (161 arquivos de teste, ~2,313 testes). Todos os módulos acrescentam e reproduzem um log de eventos encadeado:
