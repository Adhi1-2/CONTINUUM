...
pytest -q                        # ~2,314 coletados, ~2,276 passando, ~38 pulados em um ambiente mínimo (as contagens exatas variam)
...
O CONTINUUM é uma biblioteca (`src/continuum`, 124 módulos) mais uma suíte de testes grande (161 arquivos de teste, ~2,314 testes). Todos os módulos acrescentam e reproduzem um log de eventos encadeado:
