...
pytest -q                        # ~2,397 recogidos, ~2,356 pasando, ~41 saltados en un entorno mínimo (los recuentos exactos varían)
...
161 archivos de test, ~2,397 tests
